...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { comments: @name.comments, date: @name.date, guest_count_event: @name.guest_count_event } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { comments: @name.comments, date: @name.date, guest_count_event: @name.guest_count_event } }
